...
void AES::convertUnCharToStr(char * str, unsigned char * UnChar, int ucLen)
{
	int i = 0;
	for (i = 0; i < ucLen; i++)
	{
...
void AES::convertStrToUnChar(char * str, unsigned char * UnChar)
{
